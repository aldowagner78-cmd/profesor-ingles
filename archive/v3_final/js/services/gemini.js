...
export async function callGemini(prompt, imageBase64 = null) {
    ...
    const parts = [{ text: prompt + " Respond strictly in valid JSON format without Markdown code blocks." }];
    if (imageBase64) {
    ...
    try {
        ...
        if(!data.candidates || !data.candidates[0].content) throw new Error("Respuesta vacía de la IA");
        ...
        try {
            ...
            // Intentar limpiar caracteres de control comunes que rompen JSON
            try {
