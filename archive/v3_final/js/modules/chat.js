...
async function handleAction(action) {
    ...
    try {
        ...
        if(action === 'lesson') {
            prompt = `
                Actúa como un profesor de inglés experto.
                Nivel: ${currentLevel.name}
                Tema: ${currentTopic}
                
                Genera una lección corta y clara usando Markdown.
            ...
            prompt = `
                Genera una pregunta de opción múltiple sobre: ${currentTopic}.
                Responde ESTRICTAMENTE en este formato JSON:
                {
                    "type": "quiz",
                    "question": "¿Pregunta en español?",
                    "options": ["Opción A", "Opción B", "Opción C"],
                    "answer": "Opción Correcta (texto exacto)"
                }
            `;
        } else if (action === 'roleplay') {
            prompt = `
                Inicia un Roleplay sobre: ${currentTopic}.
                Responde ESTRICTAMENTE en este formato JSON:
                {
                    "type": "eval",
                    "feedback": "Vamos a practicar una situación real.",
                    "correction": null,
                    "reply": "Frase inicial en inglés para empezar el diálogo..."
                }
            `;
        } else if (action === 'next') {
